...
struct TranscriptSettingsPopover: View {
    @Binding var sizeIndex: Double // 0..4 continuous, mapped to XS/S/M/L/XL
    ...
    /// XS/S/M/L/XL from the discrete `0..4` index.
    nonisolated static func sizeLabel(for index: Double) -> String {
    ...
    nonisolated static func bubbleScale(for index: Double) -> Double {
